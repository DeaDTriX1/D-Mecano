...
AddEventHandler('fpwn_customs:finishPurchase', function(society, vehicleProps, shopCart, playerId, shopProfit)
	local xPlayer = ESX.GetPlayerFromId(source)
	...
	if Config.IsMechanicJobOnly then
		...
		if price < societyAccount.money then
			if targetMoney.money >= amount then
				...
				TriggerEvent('fpwn_customs:refreshOwnedVehicle', vehicleProps)
				isFinished = true
			else
